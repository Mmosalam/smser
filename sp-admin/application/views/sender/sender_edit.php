	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
                ...
                echo form_open_multipart('sender/sender_edit/'.$row->sender_uid, $attributes);
                ?>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sender_number" value="<?php echo $row->sender_number; ?>">
                                </div>
                            </div>
