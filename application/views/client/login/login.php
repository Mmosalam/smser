...
<div class="content" style="font-family:ArabicFont !important">
    ...
    echo form_open('client', $attributes);
    ?> 
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="رقم الجوال" name="user_uname"/>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">كلمة المرور</label>
			<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="كلمة المرور" name="user_pwd"/>
		</div>
