...
class Paypal {
	...
	function __initialize($props = array())
	{
		...
		$config["return"] 			= ''; //The URL to which PayPal redirects buyersأƒآ¢أ¢â€ڑآ¬أ¢â€‍آ¢ browser after they complete their payments.
		$config["cancel_return"]	= ''; //Specify a URL on your website that displays a أƒآ¢أ¢â€ڑآ¬أ…â€œPayment Canceledأƒآ¢أ¢â€ڑآ¬أ‚آ‌ page.
